...
counter <- 0
for (p in 1:10) {
  ahurl <- "https://www.soccerstats.com/homeaway.asp?league=scotland#"
  H <- getURL(ahurl)
  H <- readHTMLTable(H, stringsAsFactors = F, which = 7)
  ...
  H$GP <- as.numeric(H$GP)
  H$GF <- as.numeric(H$GF)
  H$GA <- as.numeric(H$GA)
  ...
  A <- getURL(ahurl)
  A <- readHTMLTable(A, stringsAsFactors = F, which = 8)
  ...
  A$GF <- as.numeric(A$GF)
  A$GA <- as.numeric(A$GA)
  ...
  matchesurl <-
    "https://www.soccerstats.com/latest.asp?league=scotland"
  matches <- getURL(matchesurl)
  matches <-
    readHTMLTable(matches, stringsAsFactors = F,  which = 10)
  matches$V1 <- NULL
  matches$V3 <- NULL
  matches$V4 <- NULL
  matches$V5 <- NULL
  ...
  h0 <-
    c(p0_0, p0_1, p0_2, p0_3, p0_4, p0_5, p0_6, p0_7, p0_8, p0_9)
  h1 <-
    c(p1_0, p1_1, p1_2, p1_3, p1_4, p1_5, p1_6, p1_7, p1_8, p1_9)
  h2 <-
    c(p2_0, p2_1, p2_2, p2_3, p2_4, p2_5, p2_6, p2_7, p2_8, p2_9)
  h3 <-
    c(p3_0, p3_1, p3_2, p3_3, p3_4, p3_5, p3_6, p3_7, p3_8, p3_9)
  h4 <-
    c(p4_0, p4_1, p4_2, p4_3, p4_4, p4_5, p4_6, p4_7, p4_8, p4_9)
  h5 <-
    c(p5_0, p5_1, p5_2, p5_3, p5_4, p5_5, p5_6, p5_7, p5_8, p5_9)
  h6 <-
    c(p6_0, p6_1, p6_2, p6_3, p6_4, p6_5, p6_6, p6_7, p6_8, p6_9)
  h7 <-
    c(p7_0, p7_1, p7_2, p7_3, p7_4, p7_5, p7_6, p7_7, p7_8, p7_9)
  h8 <-
    c(p8_0, p8_1, p8_2, p8_3, p8_4, p8_5, p8_6, p8_7, p8_8, p8_9)
  h9 <-
    c(p9_0, p9_1, p9_2, p9_3, p9_4, p9_5, p9_6, p9_7, p9_8, p9_9)
  ...
  o4.5 <-
    sum(pg$a0[6:10],
        ...
        pg$a9[1:10])
  u4.5 <-
    sum(pg$a0[1:5], pg$a1[1:4], pg$a2[1:3], pg$a3[1:2], pg$a4[1])
  BTTS_Y <-
    sum(pg$a1[2:10],
        pg$a2[2:10],
        pg$a3[2:10],
...
Markets <- do.call('rbind', Markets)
rownames(Markets) <- NULL
Markets["Decimal"] <- round(100 / Markets$Odds, 2)
