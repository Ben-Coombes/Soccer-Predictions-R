...
counter <- 0
for (p in 1:10) {
  ahurl <- "http://www.soccerstats.com/homeaway.asp?league=sweden2"
  ...
  matchesurl <-
    "http://www.soccerstats.com/latest.asp?league=sweden2#"
...
Superettan <- do.call('rbind', Superettan)
rownames(Superettan) <- NULL
Superettan["Decimal"] <- round(100 / Superettan$Odds, 2)
