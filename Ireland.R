...
counter <- 0
for (p in 1:10) {
  ahurl <- "http://www.soccerstats.com/homeaway.asp?league=ireland"
  ...
  matchesurl <-
    "http://www.soccerstats.com/latest.asp?league=ireland#"
...
Ireland <- do.call('rbind', Ireland)
rownames(Ireland) <- NULL
Ireland["Decimal"] <- round(100 / Ireland$Odds, 2)
